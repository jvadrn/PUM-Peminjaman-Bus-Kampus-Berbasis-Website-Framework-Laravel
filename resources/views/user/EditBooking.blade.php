            ...
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <input type="text" class="form-control @error('nameActivity') is-invalid @enderror" value="{{ old('nameActivity', $peminjaman->nameActivity ?? '') }}" placeholder="Masukkan Nama Kegiatan" id="kegiatan" name="nameActivity">
                            @error('nameActivity')
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                        ...
                        <input type="text" class="form-control" name="destination" value="{{ old('destination', $peminjaman->destination ?? '') }}" id="destination">
                        <!-- old('destination', $peminjaman->destination ?? '') berfungsi untuk menampilkan nilai lama atau default saat edit -->
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="date" name="departure_date" class="form-control" value="{{ old('departure_date', $peminjaman->departure_date ?? '') }}" id="departure_date">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-outline datepicker-translated">
                            ...
                            <input type="date" name="date_finish" class="form-control" value="{{ old('date_finish', $peminjaman->date_finish ?? '') }}" id="date_finish">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <input type="file" class="form-control" name="image_latter" value="{{ old('image_latter', $peminjaman->image_latter ?? '') }}" id="image_latter">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12"><button type="submit" class="btn btn-primary" name="submit">Simpan</button></div>
                    </div>
                </div>
                </form>
            </div>
